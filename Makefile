...
Makefile: RSSBlur.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d obj/RSSBlur1.0.0 || mkdir -p obj/RSSBlur1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/RSSBlur1.0.0/ && $(COPY_FILE) --parents src/RSSBlur.cpp obj/RSSBlur1.0.0/ && (cd `dirname obj/RSSBlur1.0.0` && $(TAR) RSSBlur1.0.0.tar RSSBlur1.0.0 && $(COMPRESS) RSSBlur1.0.0.tar) && $(MOVE) `dirname obj/RSSBlur1.0.0`/RSSBlur1.0.0.tar.gz . && $(DEL_FILE) -r obj/RSSBlur1.0.0
...
obj/RSSBlur.o: src/RSSBlur.cpp /usr/include/qt5/QtQuick/QtQuick \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/RSSBlur.o src/RSSBlur.cpp
...
install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/RSSBlur || mkdir -p $(INSTALL_ROOT)/usr/share/RSSBlur
	-$(INSTALL_DIR) /home/mersdk/Documents/SailfishApps/RSSBlur/qml $(INSTALL_ROOT)/usr/share/RSSBlur/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/RSSBlur/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/RSSBlur/ 


install_desktop: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/applications || mkdir -p $(INSTALL_ROOT)/usr/share/applications
	-$(INSTALL_PROGRAM) /home/mersdk/Documents/SailfishApps/RSSBlur/RSSBlur.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/RSSBlur.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/mersdk/Documents/SailfishApps/RSSBlur/RSSBlur.png $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/90x90/apps/RSSBlur.png
